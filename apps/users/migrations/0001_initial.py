    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('managed_branch', models.ForeignKey(blank=True, help_text='Branch this HR manager is responsible for (HR_EMPLOYEE role only)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='hr_managers', to='companies.branch')),
