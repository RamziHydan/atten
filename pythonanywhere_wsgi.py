...
# Replace 'yourusername' with your actual PythonAnywhere username
project_home = '/home/7hader/atten'
...
os.environ.setdefault('ALLOWED_HOSTS', '7hader.pythonanywhere.com')

# Optional: Database configuration (if using MySQL/PostgreSQL)
# os.environ.setdefault('DB_ENGINE', 'django.db.backends.mysql')
# os.environ.setdefault('DB_NAME', '7hader$attendance')
# os.environ.setdefault('DB_USER', '7hader')
# os.environ.setdefault('DB_PASSWORD', 'your-database-password')
# os.environ.setdefault('DB_HOST', '7hader.mysql.pythonanywhere-services.com')
